...
describe('SearchResult', () => {
  ...
  describe('Required Properties', () => {
    ...
    it('should have description property with correct type', () => {
      expect(Object.prototype.hasOwnProperty.call(model, 'description')).toBe(true);
      expect(typeof model.description).toBe('string');
      expect(model.description).toBe(''); // default value
    });

    it('should have type property with correct type', () => {
      expect(Object.prototype.hasOwnProperty.call(model, 'type')).toBe(true);
    ...
    it('should have found_model_name property with correct type', () => {
      expect(Object.prototype.hasOwnProperty.call(model, 'found_model_name')).toBe(true);
    ...
    it('should have icon property with correct type', () => {
      expect(Object.prototype.hasOwnProperty.call(model, 'icon')).toBe(true);
    ...
    it('should have url property with correct type', () => {
      expect(Object.prototype.hasOwnProperty.call(model, 'url')).toBe(true);
