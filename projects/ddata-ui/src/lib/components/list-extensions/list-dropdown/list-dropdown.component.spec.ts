...
describe('ListDropdownComponent', () => {
  ...
  it('createCertificate() should create certificate', () => {
    ...
    expect(component.showModal.emit).toHaveBeenCalledWith(
      new DialogContentItem(CertificationCommercialTakebackOneCreateEditComponent, newCertificate)
    );
    ...
    expect(component.showModal.emit).toHaveBeenCalledWith(
      new DialogContentItem(CertificationCommercialStockUploadCreateEditComponent, newCertificate)
    );
    ...
    expect(component.showModal.emit).toHaveBeenCalledWith(
      new DialogContentItem(CertificateCommercialWeightLossCreateEditComponent, newCertificate)
    );
    ...
    expect(component.showModal.emit).toHaveBeenCalledWith(
      new DialogContentItem(CertificateIncomingDeliveryNoteCreateEditComponent, newCertificate)
    );
    ...
    expect(component.showModal.emit).toHaveBeenCalledWith(
      new DialogContentItem(CertificateOutgoingDeliveryNoteCreateEditComponent, newCertificate)
    );
    ...
    expect(component.showModal.emit).toHaveBeenCalledWith(
      new DialogContentItem(CertificationReturnedFromCustomerCreateEditComponent, newCertificate)
    );
